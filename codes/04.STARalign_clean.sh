...
getAlign() {
	...
	outdir="test/data/04.STARalign_4"
...
export -f getAlign
# date
parallel --progress --keep-order -j 5 --line-buffer getAlign :::: <(tail -n +2 data/01.fastq/GSE_data/samplesheet.csv)
# date
/data0/apps/anaconda3/bin/multiqc -i STARalign_clean -o test/04.STAR_multi20 test/data/04.STARalign_4
